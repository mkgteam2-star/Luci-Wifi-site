    ...
    <section className="py-20 bg-card">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {[
            { q: "Who owns and operates Luci Wifi?", a: `Luci Wifi is a service of ${COMPANY.legalName}, a locally registered company based in Hillsdale, Michigan. We are independently owned and operated.` },
            { q: "How long has Luci Wifi been in business?", a: "Luci Wifi has been proudly serving the community with reliable internet and cable services, building long-term relationships with our customers through quality service and local support." },
