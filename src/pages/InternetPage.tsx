...
const InternetPage = () => (
  <>
    <SEOHead title="Internet Plans" description="Explore NLT Bundles high-speed internet plans. From 100 Mbps to 1 Gbps, find the perfect speed for your home. Call (877) 213-6707." />
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {[
            ...
            { q: "Is there a data cap on your internet plans?", a: "No — all NLT Bundles internet plans include truly unlimited data. Stream, download, and browse as much as you want without overage charges or throttling." },
