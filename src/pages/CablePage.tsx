...
const CablePage = () => (
  <>
    <SEOHead title="Cable TV Plans" description="Luci Wifi cable TV packages with 50-250+ channels. HD quality, DVR included. Call (877) 213-6707." />
    ...
    <CallToAction title="Upgrade Your Entertainment" subtitle="Call now to get started with Cable TV from Luci Wifi." />
  </>
);
