...
const steps = [
  { num: "01", title: "Check Availability", desc: "Call us or visit our website to see if NLT Bundles services your area." },
...
const testimonials = [
  { name: "Sarah M.", text: "Switched to NLT Bundles and haven't looked back. The speeds are incredible and the price is fair.", rating: 5 },
...
const faqs = [
  { q: "What areas does NLT Bundles serve?", a: "We proudly serve customers across the USA. Call us to check availability at your specific address." },
...
const Index = () => {
  ...
  return (
    <>
      <SEOHead title="Home" description="NLT Bundles offers reliable high-speed internet, cable TV, and bundle packages across the USA. Call (877) 213-6707." canonical="https://nltbundles.com/" />
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">Why Choose NLT Bundles?</h2>
          </div>
